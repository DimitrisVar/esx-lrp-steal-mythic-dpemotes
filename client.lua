 ...
 local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
         ...
         if closestPlayer ~= -1 and closestDistance <= 1.5 then
			 ...
			 if distance <= 1.5 then
				...
				exports['mythic_notify']:DoCustomHudText('error', 'The player does not raise his hands.')	
		 ...
		 exports['mythic_notify']:DoCustomHudText('error', 'There are no players near you.')
         end	  	  
